...
class SelectOrderHOMESERVICES extends StatefulWidget {
  final ParametFirestore note;

  const SelectOrderHOMESERVICES({Key key, this.note}) : super(key: key);

  @override
  Showpagee createState() => Showpagee();
}

class Showpagee extends State<SelectOrderHOMESERVICES> {
  ...
  String bookingType = "HOMESER";
  DatePickerController _controller1 = DatePickerController();
  ...
  void initState() {
    ...
    selectedDate =
        new DateTime(now.year, now.month, now.day).add(Duration(days: 1));
    ...
    options = {"HOMESER": "Home services"};
    defaultValue = "HOMESER";
  ...
  //   } else if (widget.note.id == "WEEKENDKIRTAN") {
                      ...
                      children: [
                          ...
                          children: [
                            Container(
                              ...
                              child: Text("From Date",
                                  style: Styles.text(16, Colors.grey, true)),
                            ),
                          ],
                        ),
                        Container(
                          child: DatePicker(
                            ...
                            onDateChange: (date) {
                              ...
                              setState(() {
                                selectedDate1 = date;
                                noOfDays = selectedDate2
                                        .difference(selectedDate1)
                                        .inDays +
                                    1;
                              });
                        ...
                        Container(
                          child: DatePicker(
                            ...
                            initialSelectedDate: selectedDate1,
                            selectionColor: Theme.of(context).accentColor,
                            selectedTextColor: Colors.black,
                            onDateChange: (date) {
                              // New date selected
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Column(
                      children: <Widget>[
                        Text(
                          "\Total Amount:  ${widget.note.Price * noOfDays} /-",
                          style: TextStyle(
                        ...
                        onPressed: isDisabled
                            ...
                            : () {
                                bookingDet = new BookingDetails(
                                    ...
                                    "",
                                    "",
                                    "${DateFormat('yyyy-MM-dd hh:mm a').format(selectedDate1)}",
                                    "${DateFormat('yyyy-MM-dd hh:mm a').format(selectedDate2)}",
                                    "",
