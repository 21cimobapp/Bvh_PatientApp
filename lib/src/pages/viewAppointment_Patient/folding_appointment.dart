...
class FoldingAppointment extends StatefulWidget {
  ...
  @override
  _FoldingAppointmentState createState() => _FoldingAppointmentState();
}

class _FoldingAppointmentState extends State<FoldingAppointment>
  ...
  double get openHeight =>
      ...
      FoldingAppointment.padding * 2;

  double get closedHeight =>
      _entries[0].height + FoldingAppointment.padding * 2;
  ...
  @override
  void didUpdateWidget(FoldingAppointment oldWidget) {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.all(FoldingAppointment.padding),
      height: closedHeight +
